				...
				<div class="container">
					<div class="row">
						...
						<div class="col-xs-10 text-right menu-1">
							...
							<li><a href="courses.php">Uniform</a></li>
		   			...
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1 class="heading-section">School Uniform</h1>
									<h2>Our policy on school uniform is based on the notion that the school uniform:
                                                                            Promotes a sense of pride in the school 
                                                                           and creates a sense of community/belonging towards the school.It is practical 
                                                                           and smart.Identifies the children with the school.Prevents further distractions 
                                                                           in class.Makes children feel equal to their peers in terms of appearance.</h2>
			   				</div>
			   			</div>
			   		</div>
		   		</div>
